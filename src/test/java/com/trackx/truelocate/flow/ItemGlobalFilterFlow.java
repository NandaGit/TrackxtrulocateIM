...
public class ItemGlobalFilterFlow extends GeneralActions {
	WebDriver driver;
	...
	public void setUp() throws IOException {
		...
		imitemelements = PageFactory.initElements(driver,
				IMItemElements.class);
	...
	public void itemClassGlobalFilterFlow(String sValue) throws Exception {
		try {
			...
			if(commonElements.filtetResultValidation(sValue)){
				TestNGResults.put("28", new Object[] { "Item Global Filter",
						"Item Global Filter successful", "Pass" });
			} else {
				TestNGResults.put("28", new Object[] { "Item Global Filter",
						"Item Global Filter Failed", "Fail" });
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static Object[][] filterData() {
		return GeneralActions.getData("ItemGlobalFilter");
	}
}
